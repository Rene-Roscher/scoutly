            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('organisation.create')" :active="route().current('organisation.create')">
                                    Organizations
                                </jet-nav-link>
                            </div>
                        </div>
                            ...
                            <div class="ml-3 relative">
                                <jet-dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <jet-dropdown-link :href="route('admin.index')" v-if="$page.props.auth.can['user.create']">
                                            Administration
                                        </jet-dropdown-link>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('organisation.create')" :active="route().current('organisation.create')">
                            Organisation
                        </jet-responsive-nav-link>
                    </div>
